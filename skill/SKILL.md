---
name: shippage
description: Publish HTML to a public URL instantly. Zero config — first call auto-registers. Use when the user wants to share, preview, or deploy generated HTML/web content as a live webpage accessible from any device.
version: 1.0.0
...
Publish any HTML content to a public URL. Zero config. First call auto-registers.
